...
class InstallEventCommand extends AbstractCommand
{
    /**
     * Name of the command
     * @var string
     */
    protected $name = 'CheeModule:installEvent';

    /**
     * Command description
     * @var string
     */
    protected $description = 'Run install event for a module';
    ...
    public function fire()
    {
        ...
        $this->info("Install event for $name module called.");
    }
